...
def generate_repliers(args):
    ...
    print("import \"github.com/DharitriOne/drt-chain-vm-go/ipc/common\"")
...
import (
    ...
    "github.com/DharitriOne/drt-chain-vm-go/ipc/common"
    "github.com/DharitriOne/dharitri/core/vmcommon"
)
